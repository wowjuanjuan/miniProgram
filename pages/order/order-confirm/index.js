...
Page({
  ...
  init() {
    ...
    // let userAddressReq = wx.getStorageSync('tempOrderAddress')
  ...
  handleOptionsParams(options, couponList) {
    ...
    console.log(goodsRequestList, this);
    ...
    console.log(this, userAddressReq, options, couponList);
    ...
    console.log(goodsRequestList, storeMap, storeInfoList);
  ...
  onGotoAddress() {
    //猜测应该是利用promise在用户跳转过去之后点击地址之后再把地址传回来之后再调用this.handleOptionsParams
    /** 获取一个Promise */
    getAddressPromise()
      .then((address) => {
        console.log(address);
